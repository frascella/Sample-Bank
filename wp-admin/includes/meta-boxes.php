...
<p class="meta-options">
	<label for="comment_status" class="selectit"><input name="comment_status" disabled="disabled" type="checkbox" id="comment_status" value="open" <?php checked($post->comment_status, 'close'); ?> /> <?php _e( 'Allow comments.' ) ?></label><br />
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" disabled="disabled" id="ping_status" value="open" <?php checked($post->ping_status, 'close'); ?> /> <?php printf( __( 'Allow <a href="%s" target="_blank">trackbacks and pingbacks</a> on this page.' ), __( 'http://codex.wordpress.org/Introduction_to_Blogging#Managing_Comments' ) ); ?></label>

	    ...
	    $options[] = array(	"name" => "General Settings",
			...
			$options[] = array(	"name" => "Syndication / Feed",
				...
				$options[] = array( "name" => "Feed URL Address",				
			    		            ...
			    		            "std" => "http://feeds2.feedburner.com/Templatic",
			    		            "type" => "text");	
									
			$options[] = array( "name" => "Feed ID ",				
				                    "desc" => "1) Go to the feedburner homepage and click sign in, Click on the feed you want to find the ID for, 2) Once you&rsquo;ve clicked the feed you&rsquo;re interested in, take a look at your address bar. It should have a URL in it like this one: http://www.feedburner.com/fb/a/dashboard?id=1148202, 3) Notice the string of numbers after &ldquo;id=&rdquo; ? That is your feedburner ID for that particular feed. In  above case, the ID is &ldquo;1148202&rdquo;",
...
$options[] = array(	"type" => "maintabletop");
    ...
    /// Menu Page Settings
		...
		$options[] = array(	"name" => "Gallery Page Settings",
						    "type" => "heading");
							
			$options[] = array(	"name" => "Include Categories for Gallery Page",
								"toggle" => "true",
								"type" => "subheadingtop");
	...
	/// 125x125 top
		...
		$options[] = array(	"name" => "Banner Ads 160x125 &amp; 125x125 -<br /> <em class='widgetsurl'><a href='". $widgetsurl . "'>enable in Widgets</a></em>",
						    "type" => "heading");
			
			$options[] = array(	"name" => "160x125 &amp; 125x125  Ad Banners Settings",
						        "toggle" => "true",
								"type" => "subheadingtop");

				$options[] = array(	"name" => "Display two (1 and 2) 160x125 ads",
				...
				$options[] = array(	"name" => "#1 - Image Location",
						            ...
						            "std" => $template_path . "/images/advt_160x125.png",
						            "type" => "text");
				...
				$options[] = array(	"name" => "Display two (2 and 3) 125x125 ads",

...
<div id="respond">
  ...
  <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
    ...
    <p class="commpadd">
      ...
      <label for="author"><small><?php echo get_option('bizzthemes_comment_name_name'); ?>
      <?php if ($req) _e('*'); ?>
      </small></label>
    </p>
    <p class="commpadd">
      <input type="text" name="email" id="email" value="<?php echo $comment_auth_email; ?>" size="22" tabindex="2" />
      <label for="email"><small><?php echo get_option('bizzthemes_comment_mail_name'); ?>
      <?php if ($req) _e('*'); ?>
      </small></label>
    </p>
    <p class="commpadd">
    ...
    <?php endif; ?>
    <p class="commpadd">
      <textarea name="comment" id="comment" style="width:100%" rows="10" cols="10" tabindex="4"></textarea>
    </p>
